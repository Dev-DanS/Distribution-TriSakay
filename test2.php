            ...
            axios.get(url)
                .then(response => {
                    ...
                    if (matchingToda) {
                        ...
                        const convenienceFee = Math.round((terminalDistanceKilometers) * convenienceFeePerKM);

                        dropoffPoint.bindPopup(`<b>Drop-off Point</b> <br>Distance (km):${distanceKilometers.toFixed(2)} <br>Fare: ₱${fare}<br>Convenience Fee: ₱${convenienceFee}`).openPopup();
                    }
